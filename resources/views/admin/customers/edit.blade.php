                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="is_active" class="form-select">
                            <option value="1" {{ old('is_active', $user->is_active) == '1' ? 'selected' : '' }}>Hoạt động bình thường</option>
                            <option value="0" {{ old('is_active', $user->is_active) == '0' ? 'selected' : '' }}>Khóa tài khoản</option>
                        </select>
                    </div>
                </div>
            </div>
